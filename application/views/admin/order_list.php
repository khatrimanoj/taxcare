                                    ...
                                    <table id="example" class="display text-center myTbleStyl" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?=$order['order_pan']?></td>
                                                 <!-- <td>12-1-2022</td> -->
                                                <td><span class="pendingBtn"><?=$order['order_status_name']?></span></td>
                                                <td><a class="btn btn-primary btn-sm" href="<?php echo base_url('Order/orderDetail/'.$order['order_auto_id']);?>"> view</a></td>
