                                           ...
                                           <?php
                                            foreach ($orders as $order) { ?>
                                                <tr>
													...
													<td>
                                                        <a href="<?php echo base_url() . 'Order/OrderDetail/'. $order['submit_id'] ;?>" class="btn btn-primary btn-sm waves-effect waves-light m-1">View</a>
                                                    </td>
                                                </tr>
												<?php $i++;
												}
...
<script type="text/javascript">
  $(function () {
    $("#order-datatabl").DataTable({
      "responsive": true, "lengthChange": false, "autoWidth": false, "searching": false,
      "buttons": ["excel"]
    }).buttons().container().appendTo('#order-datatabl_wrapper .col-md-6:eq(0)');
  });
</script>