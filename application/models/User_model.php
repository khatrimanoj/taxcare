...
public function get_last_calculated_total()
	...
	public function getUserlist($filterArray,$per_page, $offset){
		...
		$query    	= "select SQL_CALC_FOUND_ROWS tbl_admin_login.*, tbl_admin_login.admin_id,tbl_admin_login.fname,tbl_admin_login.email,tbl_admin_login.mobile,tbl_admin_login.username,tbl_admin_login.status,tbl_admin_login.firm_name,tbl_admin_login.designation,
